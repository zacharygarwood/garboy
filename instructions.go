...
var INSTRUCTIONS []Instruction = []Instruction{
	...
	{0x03, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x04, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x05, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x06, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x07, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x08, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x09, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x0A, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x0B, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x0C, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x0D, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x0E, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x0F, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x10, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x11, "NOP", 1, NewCycles(4, 4), (*CPU).nop},
	{0x12, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x13, "LD (BC), A", 1, NewCycles(8, 8), (*CPU).ld_r16mem_a},
	{0x14, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x15, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x16, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x17, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x18, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x19, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x1A, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x1B, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x1C, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x1D, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x1E, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x1F, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x20, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x21, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x22, "NOP", 1, NewCycles(4, 4), (*CPU).nop},
	{0x23, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x24, "LD (BC), A", 1, NewCycles(8, 8), (*CPU).ld_r16mem_a},
	{0x25, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x26, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x27, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x28, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x29, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x2A, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x2B, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x2C, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x2D, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x2E, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x2F, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x30, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x31, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x32, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
	{0x33, "NOP", 1, NewCycles(4, 4), (*CPU).nop},
	{0x34, "LD BC, u16", 3, NewCycles(12, 12), (*CPU).ld_r16_imm16},
