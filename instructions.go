...
var INSTRUCTIONS []Instruction = []Instruction{
	...
	{0x90, "SUB A, B", 1, NewCycles(4, 4), (*CPU).sub_a_r8},
	{0x91, "SUB A, C", 1, NewCycles(4, 4), (*CPU).sub_a_r8},
	{0x92, "SUB A, D", 1, NewCycles(4, 4), (*CPU).sub_a_r8},
	{0x93, "SUB A, E", 1, NewCycles(4, 4), (*CPU).sub_a_r8},
	{0x94, "SUB A, H", 1, NewCycles(4, 4), (*CPU).sub_a_r8},
	{0x95, "SUB A, L", 1, NewCycles(4, 4), (*CPU).sub_a_r8},
	{0x96, "SUB A, (HL)", 1, NewCycles(8, 8), (*CPU).sub_a_r8},
	{0x97, "SUB A, A", 1, NewCycles(4, 4), (*CPU).sub_a_r8},
	...
	{0xa0, "AND A, B", 1, NewCycles(4, 4), (*CPU).and_a_r8},
	{0xa1, "AND A, C", 1, NewCycles(4, 4), (*CPU).and_a_r8},
	{0xa2, "AND A, D", 1, NewCycles(4, 4), (*CPU).and_a_r8},
	{0xa3, "AND A, E", 1, NewCycles(4, 4), (*CPU).and_a_r8},
	{0xa4, "AND A, H", 1, NewCycles(4, 4), (*CPU).and_a_r8},
	{0xa5, "AND A, L", 1, NewCycles(4, 4), (*CPU).and_a_r8},
	{0xa6, "AND A, (HL)", 1, NewCycles(8, 8), (*CPU).and_a_r8},
	{0xa7, "AND A, A", 1, NewCycles(4, 4), (*CPU).and_a_r8},
	{0xa8, "XOR A, B", 1, NewCycles(4, 4), (*CPU).xor_a_r8},
	{0xa9, "XOR A, C", 1, NewCycles(4, 4), (*CPU).xor_a_r8},
	{0xaa, "XOR A, D", 1, NewCycles(4, 4), (*CPU).xor_a_r8},
	{0xab, "XOR A, E", 1, NewCycles(4, 4), (*CPU).xor_a_r8},
	{0xac, "XOR A, H", 1, NewCycles(4, 4), (*CPU).xor_a_r8},
	{0xad, "XOR A, L", 1, NewCycles(4, 4), (*CPU).xor_a_r8},
	{0xae, "XOR A, (HL)", 1, NewCycles(8, 8), (*CPU).xor_a_r8},
	{0xaf, "XOR A, A", 1, NewCycles(4, 4), (*CPU).xor_a_r8},
	{0xb0, "OR A, B", 1, NewCycles(4, 4), (*CPU).or_a_r8},
	{0xb1, "OR A, C", 1, NewCycles(4, 4), (*CPU).or_a_r8},
	{0xb2, "OR A, D", 1, NewCycles(4, 4), (*CPU).or_a_r8},
	{0xb3, "OR A, E", 1, NewCycles(4, 4), (*CPU).or_a_r8},
	{0xb4, "OR A, H", 1, NewCycles(4, 4), (*CPU).or_a_r8},
	{0xb5, "OR A, L", 1, NewCycles(4, 4), (*CPU).or_a_r8},
	{0xb6, "OR (HL)", 1, NewCycles(8, 8), (*CPU).or_a_r8},
	{0xb7, "OR A, A", 1, NewCycles(4, 4), (*CPU).or_a_r8},
	{0xb8, "CP A, B", 1, NewCycles(4, 4), (*CPU).cp_a_r8},
	{0xb9, "CP A, C", 1, NewCycles(4, 4), (*CPU).cp_a_r8},
	{0xba, "CP A, D", 1, NewCycles(4, 4), (*CPU).cp_a_r8},
	{0xbb, "CP A, E", 1, NewCycles(4, 4), (*CPU).cp_a_r8},
	{0xbc, "CP A, H", 1, NewCycles(4, 4), (*CPU).cp_a_r8},
	{0xbd, "CP A, L", 1, NewCycles(4, 4), (*CPU).cp_a_r8},
	...
	{0xd6, "SUB A, u8", 2, NewCycles(8, 8), (*CPU).sub_a_imm8},
	...
	{0xf6, "OR A, u8", 2, NewCycles(8, 8), (*CPU).or_a_imm8},
	...
	{0xfe, "CP A, u8", 2, NewCycles(8, 8), (*CPU).cp_a_imm8},
